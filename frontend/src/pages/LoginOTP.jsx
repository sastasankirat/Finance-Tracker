      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="backdrop-blur-2xl bg-white/10 rounded-3xl border border-white/20 p-8 shadow-2xl shadow-black/50">
          ...
          {step === 1 ? (
            ...
            <form onSubmit={handleOTPSubmit}>
              ...
              <button
                ...
                className="w-full py-4 bg-white text-black rounded-2xl hover:bg-white/90 hover:shadow-2xl hover:shadow-white/20 transition-all duration-300 font-bold tracking-wide disabled:opacity-50 disabled:cursor-not-allowed mb-4"
              >
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3.5 backdrop-blur-md bg-white/5 border border-white/20 text-gray-300 rounded-2xl hover:bg-white/10 hover:border-white/30 transition-all duration-300 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Resend OTP
              </button>
          ...
          <div className="mt-6 text-center text-sm text-gray-400">
            <Link to="/login" className="text-white hover:text-gray-200 font-semibold transition-colors underline decoration-white/30 hover:decoration-white/60">
              ← Back to login
            </Link>
          </div>
        </div>
